...
# $Id: //depot/DateTime-Format-Excel/lib/DateTime/Format/Excel.pm#3 $
...
and Unix epoch times.

If you happen to be dealing with dates between S<1 Jan 1900> and
S<1 Mar 1900> please read the notes on L<epochs>.

=head1 CONSTRUCTORS

=head2 new

Creates a new DateTime::Format::Excel instance. This is generally
...
L<http://rt.cpan.org/>, or email
E<lt>bug-datetime-format-excel@rt.cpan.orgE<gt>.
